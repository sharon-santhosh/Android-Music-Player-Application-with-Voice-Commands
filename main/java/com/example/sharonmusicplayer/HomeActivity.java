package com.example.sharonmusicplayer;
...
public class HomeActivity extends AppCompatActivity
{
    ...
    private void displayAudioSongsName()
    {
        ...
        ArrayAdapter<String> arrayAdapter=new ArrayAdapter<String>(HomeActivity.this, android.R.layout.simple_list_item_1,itemsAll);
